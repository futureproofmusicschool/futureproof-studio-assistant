import { CONTACT_STATUSES, ContactStatus, LOG_CHANNELS, LogChannel, ContactLogEntry, ContactLogAppend, ContactCategory, Contact, Contacts, ContactInput, ContactUpdate, isRecord, isIsoDateOrNull, isValidStatus, isValidLogEntry, isValidLog, isValidHistoryOperationId, isValidContactLogAppend, isValidTimestamp, isValidCategories, isValidContactValue, isValidContacts, isValidLastContact, createContactId, isValidContactId, assertValidContactInput, assertValidContactUpdate } from "./contact-domain";
