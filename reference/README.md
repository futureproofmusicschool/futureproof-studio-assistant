...
The reference shelf. Drop full manuals and documentation here — sample
libraries, plugins, hardware — and the assistant can search them when you ask
technical questions.

## How to use it

1. Put the file in this folder. **PDF, .docx, .md, and .txt** all work; no
...
Everything in this folder except this README is **gitignored**. Manuals are
usually someone else's copyrighted text, and what you own is your business.
